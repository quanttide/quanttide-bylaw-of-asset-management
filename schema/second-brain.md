...
**第一条** GitHub 公开仓库是量潮知识资产的主要形态：20 类标准资产（18 类九宫格资产 + Context、Archive 两类不占格资产）均以公开仓库为载体。

**第二条** 本章程规定量潮 GitHub 组织下各仓库的命名与组织结构，为仓库创建、目录结构与挂载路径提供依据。

**第三条** 本章程适用于量潮 GitHub 组织下的全部公开仓库，新增仓库须按本章程命名与组织。
